...
public class Servidor {
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            ...
            // Crear una hebra para manejar la conexión del cliente
...
class ClienteHandler implements Runnable {
    ...
    public void run() {
        try {
            ...
            salida.println("¿Desea subir una imagen al servidor o descargar las imágenes del servidor? (subir/descargar)");
